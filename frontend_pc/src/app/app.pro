...
-lITKBiasCorrection-5.0.1 -lITKCommon-5.0.1 -lITKDICOMParser-5.0.1 -lITKEXPAT-5.0.1 -lITKIOBMP-5.0.1 -lITKIOBioRad-5.0.1 -lITKIOBruker-5.0.1 \
-lITKIOCSV-5.0.1 -lITKIOGDCM-5.0.1 -lITKIOGE-5.0.1 -lITKIOGIPL-5.0.1 -lITKIOHDF5-5.0.1 -lITKIOIPL-5.0.1 -lITKIOImageBase-5.0.1 \
-lITKIOJPEG-5.0.1 -lITKIOJPEG2000-5.0.1 -lITKIOLSM-5.0.1 -lITKIOMINC-5.0.1 -lITKIOMRC-5.0.1 -lITKIOMeshBYU-5.0.1 -lITKIOMeshBase-5.0.1 \
-lITKIOMeshFreeSurfer-5.0.1 -lITKIOMeshGifti-5.0.1 -lITKIOMeshOBJ-5.0.1 -lITKIOMeshOFF-5.0.1 -lITKIOMeshVTK-5.0.1 -lITKIOMeta-5.0.1 -lITKIONIFTI-5.0.1 \
-lITKIONRRD-5.0.1 -lITKIOPNG-5.0.1 -lITKIOSiemens-5.0.1 -lITKIOSpatialObjects-5.0.1 -lITKIOStimulate-5.0.1 -lITKIOTIFF-5.0.1 -lITKIOTransformBase-5.0.1 \
-lITKIOTransformHDF5-5.0.1 -lITKIOTransformInsightLegacy-5.0.1 -lITKIOTransformMatlab-5.0.1 -lITKIOVTK-5.0.1 -lITKIOXML-5.0.1 \
-lITKKLMRegionGrowing-5.0.1 -lITKLabelMap-5.0.1 \
-lITKMesh-5.0.1 -lITKMetaIO-5.0.1 -lITKNrrdIO-5.0.1 -lITKOptimizers-5.0.1 -lITKOptimizersv4-5.0.1 -lITKPath-5.0.1 -lITKPolynomials-5.0.1 \
-lITKQuadEdgeMesh-5.0.1 -lITKSpatialObjects-5.0.1 -lITKStatistics-5.0.1 -lITKTestKernel-5.0.1 -lITKTransform-5.0.1 -lITKTransformFactory-5.0.1 \
-lITKVNLInstantiation-5.0.1 \
-lITKVTK-5.0.1 -lITKVideoCore-5.0.1 -lITKVideoIO-5.0.1 -lITKVtkGlue-5.0.1 -lITKWatersheds-5.0.1 -lITKgiftiio-5.0.1 -lITKniftiio-5.0.1 \
-lITKznz-5.0.1 -litkNetlibSlatec-5.0.1 -litkdouble-conversion-5.0.1 -litkgdcmCommon-5.0.1 -litkgdcmDICT-5.0.1 -litkgdcmDSED-5.0.1 -litkgdcmIOD-5.0.1 \
-litkgdcmMEXD-5.0.1 -litkgdcmMSFF-5.0.1 -litkgdcmcharls-5.0.1 \
-litkopenjpeg-5.0.1 -litkpng-5.0.1 -litksys-5.0.1 \
-litktestlib-5.0.1 -litktiff-5.0.1 -litkv3p_netlib-5.0.1 -litkvcl-5.0.1 -litkvnl-5.0.1 -litkvnl_algo-5.0.1 -litkzlib-5.0.1
